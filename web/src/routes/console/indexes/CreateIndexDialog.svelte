...
<div class="mb-6 rounded-lg bg-white p-6 shadow" data-testid="create-index-form">
	<h2 class="mb-2 text-lg font-medium text-flapjack-ink">Create a new index</h2>
	<p class="mb-4 text-sm text-flapjack-ink/70">
		Pick a template to seed the index, then confirm the stable name and hosting region.
	</p>
