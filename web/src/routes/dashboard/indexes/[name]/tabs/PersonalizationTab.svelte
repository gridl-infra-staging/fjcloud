<script lang="ts">
	...
	$effect(() => {
		...
		<div class="mb-6 rounded-lg bg-white p-6 shadow" data-testid="personalization-section" data-index={index.name}>
			...
			<div class="mb-6 rounded-md border border-gray-200 p-4">
				...
				<form method="POST" action="?/savePersonalizationStrategy" use:enhance>
					<label for="personalization-strategy-json" class="mb-2 block text-sm font-medium text-gray-700"
						>Strategy JSON</label
					>
					<textarea
			...
			<div class="rounded-md border border-gray-200 p-4">
				...
				{#if personalizationProfile}
					<div class="rounded-md border border-gray-200 bg-gray-50 p-3">
						...
						<pre class="mb-3 overflow-x-auto whitespace-pre-wrap rounded bg-white p-3 font-mono text-xs text-gray-700"
							>{JSON.stringify(personalizationProfile, null, 2)}</pre
						>
