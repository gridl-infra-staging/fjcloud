...
These constants represent measured resource envelopes for three document tiers.

Values should be updated from `scripts/reliability/profiles/` after a real

profiling run. |
| flapjack_proxy_test_support.rs | Stub summary for /Users/stuart/parallel_development/fjcloud_dev/MAR17_11_2_data_management_features/fjcloud_dev/infra/api/tests/common/flapjack_proxy_test_support.rs. |
