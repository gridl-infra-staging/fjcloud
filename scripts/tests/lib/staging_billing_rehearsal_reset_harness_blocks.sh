...
# Emit the psql mock script body used by rehearsal reset harness tests.
# TODO: Document mock_psql_reset_script_block.
# TODO: Document mock_psql_reset_script_block.
# TODO: Document mock_psql_reset_script_block.
# TODO: Document mock_psql_reset_script_block.
# TODO: Document mock_psql_reset_script_block.
# Emit the deterministic psql mock used to exercise every rehearsal reset state transition.
# Callers embed the returned script block in an isolated test executable.
# TODO: Document mock_psql_reset_script_block.
# TODO: Document mock_psql_reset_script_block.
