...
- All resource-based providers expose ascending RAM tiers and compatible RAM field names:
  - Meilisearch `INSTANCE_TIERS[*].ram_gib: u16` ([infra/pricing-calculator/src/providers/meilisearch_resource_based.rs:30](infra/pricing-calculator/src/providers/meilisearch_resource_based.rs:30), [37](infra/pricing-calculator/src/providers/meilisearch_resource_based.rs:37), sorted test [112](infra/pricing-calculator/src/providers/meilisearch_resource_based.rs:112)).
  - Typesense `RAM_TIERS[*].ram_gib: u16` ([infra/pricing-calculator/src/providers/typesense_cloud.rs:26](infra/pricing-calculator/src/providers/typesense_cloud.rs:26), [34](infra/pricing-calculator/src/providers/typesense_cloud.rs:34), sorted test [92](infra/pricing-calculator/src/providers/typesense_cloud.rs:92)).
  - Elastic `INSTANCE_TIERS[*].ram_gib: u16` ([infra/pricing-calculator/src/providers/elastic_cloud.rs:25](infra/pricing-calculator/src/providers/elastic_cloud.rs:25), [34](infra/pricing-calculator/src/providers/elastic_cloud.rs:34), sorted test [86](infra/pricing-calculator/src/providers/elastic_cloud.rs:86)).
  - AWS OpenSearch `INSTANCE_TYPES[*].ram_gib: u16` ([infra/pricing-calculator/src/providers/aws_opensearch.rs:29](infra/pricing-calculator/src/providers/aws_opensearch.rs:29), [37](infra/pricing-calculator/src/providers/aws_opensearch.rs:37), sorted test [112](infra/pricing-calculator/src/providers/aws_opensearch.rs:112)).
- Storage and bandwidth constants exist only in providers today, not in shared helpers yet:
  - Meili storage/bandwidth constants: [71](infra/pricing-calculator/src/providers/meilisearch_resource_based.rs:71), [80](infra/pricing-calculator/src/providers/meilisearch_resource_based.rs:80).
  - AWS storage constant: [83](infra/pricing-calculator/src/providers/aws_opensearch.rs:83).
Open questions:
...
- `Decimal` matches existing cost types (`CostLineItem.quantity`, `unit_price_cents`) and avoids premature float rounding ([infra/pricing-calculator/src/types.rs:147](infra/pricing-calculator/src/types.rs:147), [151](infra/pricing-calculator/src/types.rs:151)).
Open questions:
...
- `lib.rs` currently exports only `providers` and `types` ([infra/pricing-calculator/src/lib.rs:1](infra/pricing-calculator/src/lib.rs:1)).
- `providers/mod.rs` is Stage 2 registry plumbing and should not be touched for Stage 3 helper introduction ([infra/pricing-calculator/src/providers/mod.rs:1](infra/pricing-calculator/src/providers/mod.rs:1), [63](infra/pricing-calculator/src/providers/mod.rs:63)).
Open questions:
- None.
...
Evidence anchor: `storage_gib()` should remain single source ([infra/pricing-calculator/src/types.rs:86](infra/pricing-calculator/src/types.rs:86)).
Open questions:
...
Evidence:
- Meili pricing constant is per-GB, not GiB ([infra/pricing-calculator/src/providers/meilisearch_resource_based.rs:80](infra/pricing-calculator/src/providers/meilisearch_resource_based.rs:80)).
Open questions:
...
Evidence anchor: single-source storage derivation in [infra/pricing-calculator/src/types.rs:86](infra/pricing-calculator/src/types.rs:86).
Open questions:
- None.
...
- Expected remaining ignores in `lib.rs` test block are the Stage 6 comparison contract tests ([infra/pricing-calculator/src/lib.rs:74](infra/pricing-calculator/src/lib.rs:74), [85](infra/pricing-calculator/src/lib.rs:85), [104](infra/pricing-calculator/src/lib.rs:104), [117](infra/pricing-calculator/src/lib.rs:117)).
Open questions:
- None.
