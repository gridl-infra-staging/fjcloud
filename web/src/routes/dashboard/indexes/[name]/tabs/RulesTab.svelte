...
>
	...
	<p class="mb-4 text-sm text-gray-600">Create and manage ranking rules for this index.</p>
	...
	<div class="rounded-md border border-gray-200 p-4">
		...
		<form method="POST" action="?/saveRule" use:enhance>
			<label for="rule-object-id" class="mb-2 block text-sm font-medium text-gray-700"
				>Object ID</label
			>
			<input
				id="rule-object-id"
