...
fn test_app(customer_repo: std::sync::Arc<crate::common::MockCustomerRepo>) -> axum::Router {
    api::router::build_router(crate::common::test_state_with_repo(customer_repo))
}

fn test_app_with_api_key_repo(
    customer_repo: std::sync::Arc<crate::common::MockCustomerRepo>,
    api_key_repo: std::sync::Arc<crate::common::MockApiKeyRepo>,
) -> axum::Router {
    api::router::build_router(crate::common::test_state_with_api_key_repo(
        customer_repo,
        api_key_repo,
    ))
}
...
struct DeletedAccountContext {
    app: axum::Router,
    repo: std::sync::Arc<crate::common::MockCustomerRepo>,
    token: String,
    customer_id: Uuid,
    email: &'static str,
    password: &'static str,
