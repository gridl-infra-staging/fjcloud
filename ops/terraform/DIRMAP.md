...
| Directory | Summary |
| --- | --- |
| support_email_canary | AWS Lambda handler that executes a support email deliverability canary script and resolves optional webhook URLs (Slack/Discord) from SSM Parameter Store for alert notifications. |
<!-- [scrai:end] -->
