...
<body>
  <header class="topbar">
    <div class="wrap topbar-inner">
      ...
      <nav class="nav" aria-label="Primary">
        ...
        <a class="button" href="{CANONICAL_URL}login">Log in</a>
      </nav>
    </div>
  </header>
  ...
  <main>
    <section class="hero">
      <div class="wrap hero-grid">
        <div>
          <p class="eyebrow">Search hosting for real apps</p>
          <h1>Flapjack Cloud</h1>
          <p class="lede">Hosted Flapjack search without search-server operations.</p>
          <p class="copy">Bring your existing Algolia-shaped client code, create indexes from the dashboard or API, and keep storage, keys, regions, usage, and billing in one place.</p>
          <p class="copy"><strong>Public beta.</strong> Public beta is intentionally narrow: email support, review pricing before paid billing, and expect limits to change before GA.</p>
          <div class="actions">
        ...
        <section class="card" aria-label="Quick facts">
          ...
          <dl class="facts">
            <div><dt>What it is</dt><dd>Managed Flapjack indexes behind an Algolia-compatible search API.</dd></div>
            <div><dt>What you manage</dt><dd>Documents, settings, keys, regions, usage, and billing from the dashboard.</dd></div>
            <div><dt>Beta status</dt><dd>Public beta with support at {SUPPORT_EMAIL}</dd></div>
          </dl>
        </section>
      </div>
    </section>
    ...
    <section class="band" id="product">
      <div class="wrap">
        ...
        <h2>What you get</h2>
        <p class="copy">Flapjack Cloud runs the search service so your team can focus on relevance, content, and customer experience instead of search-server operations.</p>
        <div class="grid">
    ...
    <section class="band" id="contact">
      <div class="wrap">
        <h2>Contact</h2>
        <p class="copy">Email <a href="mailto:{SUPPORT_EMAIL}">{SUPPORT_EMAIL}</a> for beta access, API questions, billing help, privacy requests, or security reports.</p>
      </div>
    </section>
  </main>
  ...
  <footer>
    <div class="wrap footer-inner">
      <span>&copy; 2026 Flapjack Cloud. Support: {SUPPORT_EMAIL}</span>
