<script lang="ts">
  ...
  import type { EditorDialogMode, EditorDialogOnSave, EditorDialogValues } from "$lib/components/EditorDialog.types";
...
<div>
  <button type="button" data-testid="demo-open-create" on:click={openCreateScenario}>Open create mode</button>
  <button type="button" data-testid="demo-open-edit" on:click={openEditScenario}>Open edit mode</button>
  <button type="button" data-testid="demo-open-dirty-dismiss" on:click={openDirtyDismissScenario}>Open dirty dismiss</button>
  <button type="button" data-testid="demo-open-pending-save" on:click={openPendingSaveScenario}>Open pending save</button>
  <button type="button" data-testid="demo-open-rejected-save" on:click={openRejectedSaveScenario}>Open rejected save</button>
  <button type="button" data-testid="demo-open-successful-save" on:click={openSuccessfulSaveScenario}>Open successful save</button>
  <button type="button" data-testid="demo-resolve-pending-save" on:click={resolvePendingSave}>Resolve pending save</button>
</div>
