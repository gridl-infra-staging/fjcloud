...
| ------------------------- | ---------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------- |
| Local signoff             | COMPLETE (local evidence)                | Canonical local signoff contract in [`docs/runbooks/local-dev.md`](./local-dev.md) and the Apr 19 run-scoped pass referenced by current roadmap status | None for local-only scope                |
...
| Billing dry run           | PREP COMPLETE, EXECUTION OUTSTANDING     | [`docs/runbooks/staging_billing_dry_run.md`](./staging_billing_dry_run.md), [`ROADMAP.md`](../../ROADMAP.md), [`PROJECT_OVERVIEW.md`](../../PROJECT_OVERVIEW.md)                                | Credentialed staging billing lane        |
| Remaining launch blockers | LIVE CREDENTIALS / EVIDENCE              | Current open items in [`ROADMAP.md`](../../ROADMAP.md) and [`PROJECT_OVERVIEW.md`](../../PROJECT_OVERVIEW.md)                                                                                   | Launch owner                             |
...
- Canonical scope and proof contract: [`docs/runbooks/local-dev.md`](./local-dev.md)
- Current checked-in status:
  - `ROADMAP.md` and `PROJECT_OVERVIEW.md` treat P0 local simulation as complete.
...
- Do not add copied status tables that restate wrapper `summary.json` output, `ROADMAP.md`, or `PROJECT_OVERVIEW.md`.
