...
- Observation UTC: 2026-05-05T17:40:37Z
...
1. `dig +short CNAME cloud.flapjack.foo @1.1.1.1`
- Expected success signal: output contains `flapjack-cloud.pages.dev.`

2. `curl -sI https://cloud.flapjack.foo/`
- Expected success signal: HTTP status line indicates `200`.
...
url = "https://api.cloudflare.com/client/v4/zones/fafbf95a076d7e8ee984dbd18a62c933/bot_management"
EOF
```
