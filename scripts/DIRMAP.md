...
| launch | Launch-stage orchestration and verification scripts for fjcloud's deployment pipeline, including guarded rollouts, live Stripe/SES testing, browser validation against deployed environments, post-deploy verification, and Wave 3 closeout evidence capture. |
