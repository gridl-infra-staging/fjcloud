...
Bundle: `docs/runbooks/evidence/ses-coverage-a1/20260711T212230Z_in_vpc_rerun`
...
- `verify_email_clickthrough`: rc=1 pass=0
  ...
  - Observed detail: ERROR: email_verified_at not set after clickthrough for verifyprobe2026071121224729508@test.flapjack.foo after 15 attempts
...
- `password_reset_clickthrough`: rc=1 pass=0
  ...
  - Observed detail: ERROR: password_reset_token not cleared after reset for resetprobe202607112123593882@test.flapjack.foo after 15 attempts
