...
| api | The api directory contains an Axum-based HTTP server for multi-tenant cloud infrastructure management with usage-based billing, Stripe integration, and multi-cloud provisioning support (AWS/GCP/OCI/Hetzner), along with comprehensive integration tests covering tenant isolation, Stripe webhooks, Flapjack proxy operations, and storage metering. |
