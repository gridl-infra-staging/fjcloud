...
## Optional onboarding credential route examples

From `infra/api/src/routes/onboarding.rs`. These errors apply to optional search/browse-key generation, not to the primary JWT first-search path in [Customer Quickstart](./customer-quickstart.md).
