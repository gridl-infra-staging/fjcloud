...
| api | The api crate is the HTTP API server for fjcloud, providing HTTP routing, authentication, billing/invoicing, multi-cloud provisioning, and integrations with Stripe, email, and DNS services. |
