...
SES_REGION="$(ssm_value "/fjcloud/${ENVIRONMENT}/ses_region")"
...
require_value "ses_region" "$SES_REGION"
...
#
# WHY SES_REGION is hydrated here: Section 1 SES probes use the same host env
# file emitted by this hydrator, and the clickthrough, bounce/complaint, and
# staging dunning probes all require an explicit SES region before making live
# SES or CloudWatch calls.
#
