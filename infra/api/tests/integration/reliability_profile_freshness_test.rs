...
//! are consistent with the constants in `crate::common::capacity_profiles`.
//!
...
fn profile_mem_drift_within_tolerance() {
    let profiles = [
        (
            "1k",
            crate::common::capacity_profiles::PROFILE_1K.mem_rss_bytes,
        ),
        (
            "10k",
            crate::common::capacity_profiles::PROFILE_10K.mem_rss_bytes,
        ),
        (
            "100k",
            crate::common::capacity_profiles::PROFILE_100K.mem_rss_bytes,
        ),
    ];
...
fn profile_disk_drift_within_tolerance() {
    let profiles = [
        (
            "1k",
            crate::common::capacity_profiles::PROFILE_1K.disk_bytes,
        ),
        (
            "10k",
            crate::common::capacity_profiles::PROFILE_10K.disk_bytes,
        ),
        (
            "100k",
            crate::common::capacity_profiles::PROFILE_100K.disk_bytes,
        ),
    ];
