...
Yes. Once usage exceeds the free tier, a $10/month floor applies (`minimum_spend_cents: 1000` in `RateCard`). Shared-plan customers have a $5/month floor (`shared_minimum_spend_cents: 500`).
