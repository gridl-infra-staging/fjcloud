...
crate::integration_test!(integration_flapjack_health_check, async {
...
crate::integration_test!(integration_flapjack_proxy_register_and_login, async {
    let client = http_client();
    let base = api_base();
...
crate::integration_test!(integration_flapjack_proxy_create_index, async {
    let client = http_client();
    let base = api_base();
...
crate::integration_test!(integration_flapjack_proxy_delete_index, async {
    let client = http_client();
    let base = api_base();
...
crate::integration_test!(integration_flapjack_proxy_create_search_key, async {
    let client = http_client();
    let base = api_base();
...
crate::integration_test!(integration_flapjack_proxy_bogus_key_rejected, async {
    let client = http_client();
    let fj_base = flapjack_base();
...
crate::integration_test!(integration_flapjack_proxy_update_settings, async {
    let client = http_client();
    let base = api_base();
...
crate::integration_test!(integration_flapjack_proxy_tenant_isolation_read, async {
    let client = http_client();
    let base = api_base();
