# workers=2 run 1 parsed comparison

baseline_log=docs/runbooks/evidence/playwright-fixture-salvage/20260709T230655Z/01_workers1_control.log
workers2_log=docs/runbooks/evidence/playwright-fixture-salvage/20260709T233241Z/02_workers2_run1.log
baseline_counts=['18 failed', '19 skipped', '283 passed (17.2m)']
workers2_counts=['18 failed', '19 skipped', '283 passed (9.1m)']
baseline_time={'real': '1033.57', 'user': '215.99', 'sys': '48.00'}
workers2_time={'real': '547.82', 'user': '217.14', 'sys': '50.35'}
new_failures_vs_workers1=0
missing_baseline_failures=0

workers2_failing_set:
