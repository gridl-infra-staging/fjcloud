...
- Related routes: `/`, `/terms`, `/dpa`
- Audience: unauthenticated prospects and authenticated customers reviewing privacy terms
- Priority: P0

## User Goal

Read privacy policy content with clear section headings, effective date, and support/legal navigation.

## Target Behavior

The page renders a single legal article card with a back link to `/`, the `Privacy Policy` heading, an effective-date header, canonical privacy sections, and the shared legal footer/support contract.
...
- Success: Privacy heading, effective date, all expected section headings, and shared support footer are visible and consistent.
...
- [ ] The page body renders `Privacy Policy` and the route-specific effective date.
...
- Component tests: `web/src/routes/privacy/privacy.test.ts`
