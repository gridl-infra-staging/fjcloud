...
from emit_dispatch_manifest import REPO_CHAT_ROOT, emit_dispatch_manifest, main
    ...
    def test_orders_size_bands_by_s_m_l_xl_uses_index_order_and_chunks_to_four(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            command_lines = [
                ...
                if line.strip().startswith(f"- `batman {REPO_CHAT_ROOT}/")
            ]
            expected_paths = [
                str(REPO_CHAT_ROOT / entry["path"].removeprefix("chats/icg/"))
