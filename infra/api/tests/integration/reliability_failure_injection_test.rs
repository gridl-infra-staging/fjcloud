...
struct FlakyUsageRepo {
    inner: Arc<crate::common::MockUsageRepo>,
...
impl FlakyUsageRepo {
    fn new() -> Self {
        Self {
            inner: Arc::new(crate::common::MockUsageRepo::new()),
...
async fn setup_replication_failure_harness() -> crate::common::ReplicationHarness {
    crate::common::setup_replication_harness(ReplicationConfig::default(), true).await
}
...
async fn metering_db_disconnect_returns_500_with_bounded_attempts_then_recovers() {
    ...
    let mut state = crate::common::test_state_with_repo(customer_repo);
