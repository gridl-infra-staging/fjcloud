...
# Add common libpq and PostgreSQL binary directories to PATH when psql is not already available.
# TODO: Document ensure_psql_on_path.
# TODO: Document ensure_psql_on_path.
# TODO: Document ensure_psql_on_path.
# TODO: Document ensure_psql_on_path.
# TODO: Document ensure_psql_on_path.
# Keep an already resolvable psql unchanged; otherwise prepend the first installed candidate.
# Return failure when none of the supported PostgreSQL binary directories contains psql.
# TODO: Document ensure_psql_on_path.
# TODO: Document ensure_psql_on_path.
ensure_psql_on_path() {
