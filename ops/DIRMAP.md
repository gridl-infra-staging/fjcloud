...
| scripts | The scripts directory contains deployment and infrastructure automation tools for fjcloud, including zero-downtime deployments via SSM, database migrations, RDS restore workflows, AWS bootstrap provisioning and validation, and shared utilities for AWS/DNS operations. |
