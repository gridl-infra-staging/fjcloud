...
async fn create_index_key_rejects_description_over_1000_chars() {
    let customer_repo = Arc::new(crate::common::MockCustomerRepo::new());
    let deployment_repo = Arc::new(crate::common::MockDeploymentRepo::new());
    let tenant_repo = Arc::new(crate::common::MockTenantRepo::new());
    ...
    let app = crate::common::test_app_with_indexes(
        customer_repo,
        deployment_repo,
        tenant_repo,
        crate::common::mock_flapjack_proxy(),
    );
