...
| api | The api crate is an Axum-based HTTP server providing multi-tenant billing, infrastructure management, Stripe payment integration, and cloud provisioning across AWS/GCP/OCI/Hetzner, along with DNS management and webhook services. |
