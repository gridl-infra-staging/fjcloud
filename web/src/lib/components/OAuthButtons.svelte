...
<div class="space-y-3">
	...
	{#each oauthButtons as button (button.provider)}
		<a
			class="flex w-full items-center justify-center gap-3 rounded border border-flapjack-ink/30 px-4 py-2 font-medium text-flapjack-ink/80 hover:bg-flapjack-cream/80 focus:ring-2 focus:ring-flapjack-rose focus:ring-offset-flapjack-cream"
