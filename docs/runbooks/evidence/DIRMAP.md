...
| alert_emails | — |
| database-recovery | — |
| fleet-recovery | The fleet-recovery directory contains timestamped operational artifacts documenting a multi-stage recovery workflow, with shell scripts implementing diagnostic, reconciliation, capacity restoration, monitoring, and closeout procedures for infrastructure recovery operations. |
