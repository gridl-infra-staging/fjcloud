...
# Return success when an environment or Terraform name is likely to contain a secret value.
# TODO: Document is_secret_bearing_name.
# TODO: Document is_secret_bearing_name.
# TODO: Document is_secret_bearing_name.
# TODO: Document is_secret_bearing_name.
# TODO: Document is_secret_bearing_name.
# Normalize the candidate name before matching credential, connection, and token patterns.
# Return success only for names likely to carry secret values.
# TODO: Document is_secret_bearing_name.
# TODO: Document is_secret_bearing_name.
is_secret_bearing_name() {
  ...
  if [[ "$lower" =~ (^|_)[a-z0-9]+_token($|_) ]]; then
    return 0
  fi
