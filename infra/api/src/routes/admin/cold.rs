...
pub async fn admin_restore(
        ...
        .await
    {
        ...
        Err(crate::services::restore::RestoreError::DestinationConflict) => {
            Err(ApiError::Conflict("destination_conflict".into()))
        }
        Err(crate::services::restore::RestoreError::DestinationChanged) => {
            Err(ApiError::Conflict("destination_changed".into()))
        }
