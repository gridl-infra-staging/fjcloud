...
impl RestoreHarness {
    ...
    fn build_service_with_deps(
        ...
        RestoreService::new_without_lifecycle_guard_for_tests(
            config,
...
async fn restore_legacy_compact_object_key_falls_back_to_source_vm_region() {
    ...
    let svc = RestoreService::new_without_lifecycle_guard_for_tests(
...
async fn restore_download_failure_resets_tier_to_cold() {
    ...
    let failing_store = Arc::new(crate::common::FailableObjectStore::new(
