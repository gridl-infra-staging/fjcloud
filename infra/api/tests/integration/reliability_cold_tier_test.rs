...
use crate::common::MockNodeClient;
use api::repos::{ColdSnapshotRepo, InMemoryColdSnapshotRepo, TenantRepo};
...
struct TestHarness {
    ...
    failable_store: Arc<crate::common::FailableObjectStore>,
...
impl TestHarness {
    fn new() -> Self {
        ...
        let failable_store = Arc::new(crate::common::FailableObjectStore::new(
...
async fn s3_auth_revocation_during_snapshot_upload_fires_critical_alert() {
    ...
    let candidate = h.candidate(customer_id, "products", vm_id).await;
