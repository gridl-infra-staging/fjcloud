...
ROOT_GROUPS: dict[str, tuple[str, ...]] = {
    ...
    "auth_admin": (
        ...
        "admin_usage_audit_test",
        "admin_vm_kill_test",
        "admin_vm_host_metrics_test",
        "admin_vm_lifecycle_events_test",
        "admin_vm_orphans_test",
        "admin_vms_test",
    ...
    "platform": (
        ...
        "migration_capabilities_route_test",
        "migration_preview_media_type_test",
        ...
        "version_test",
        "vm_autorepair_test",
        "vm_health_rollup_test",
        "vm_host_metrics_repo_test",
        "vm_lifecycle_events_repo_test",
        "vm_inventory_test",
        "webhook_alert_test",
