...
pub(crate) const SEARCH_REQUESTS_TOTAL: &str = "flapjack_search_requests_total";
pub(crate) const DOCUMENTS_INDEXED_TOTAL: &str = "flapjack_documents_indexed_total";
pub(crate) const DOCUMENTS_COUNT: &str = "flapjack_documents_count";
pub(crate) const STORAGE_BYTES: &str = "flapjack_storage_bytes";
