	...
	{#if wizardStep === 'billing'}
		...
		>
			...
			<p class="mt-2 text-sm text-flapjack-ink/80">
				Your Paid plan needs a payment method before onboarding can continue.
			</p>
			<a
		...
		<div data-testid="onboarding-step-1">
			<div class="rounded-lg bg-white p-6 shadow">
				...
				<p class="mb-4 text-sm text-flapjack-ink/70">
					Choose the region where the index will run, then use a stable index name for your app and
					API calls.
				</p>
