...
assert_transition_invoice_map() {
    ...
    assert_eq "$(json_file_transition_invoice_id "$json_path" "failed")" "11111111-1111-4111-8111-111111111111" \
        "$artifact_label payload should emit failed transition invoice ID"
    assert_eq "$(json_file_transition_invoice_id "$json_path" "suspended")" "22222222-2222-4222-8222-222222222222" \
        "$artifact_label payload should emit suspended transition invoice ID"
    assert_eq "$(json_file_transition_invoice_id "$json_path" "recovered")" "11111111-1111-4111-8111-111111111111" \
