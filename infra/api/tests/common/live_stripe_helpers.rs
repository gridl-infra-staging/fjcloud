// Live Stripe helpers are compiled into the shared platform test harness even
// when the selected test set does not exercise the live Stripe lane.
#![allow(dead_code)]

//! Stub summary for live_stripe_helpers.rs.
