...
| publish_canary_image_shared.sh | Shared canary Lambda image publish orchestration.
...
| tests_publish_scripts_buildx_static.sh | Static contract for Lambda canary image publishing.
...
| tests_rds_restore_evidence_unit_execute_and_poll_contract.sh | Execute-path and polling failure contracts extracted from the main unit harness. |
...
| Directory | Summary |
| --- | --- |
| support_email_canary | This is an AWS Lambda-based canary that monitors support email functionality, validating email delivery and system health through automated health checks. |
<!-- [scrai:end] -->
