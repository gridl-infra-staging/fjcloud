...
// Run with: INTEGRATION=1 cargo test -p api --test platform integration_smoke_test::

use crate::common::integration_helpers::{api_base, http_client};

crate::integration_test!(integration_smoke_health_check, async {
