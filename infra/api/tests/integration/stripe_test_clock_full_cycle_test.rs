...
async fn stripe_test_clock_full_cycle_bills_expected_amount() {
    ...
    crate::require_live!(
        crate::common::integration_helpers::integration_enabled(),
    ...
    crate::require_live!(
        crate::common::live_stripe_helpers::stripe_price_starter_configured(),
        "STRIPE_PRICE_STARTER must be set to a Stripe price_ identifier"
    );
    crate::require_live!(
        crate::common::live_stripe_helpers::expected_starter_unit_amount_cents().is_ok(),
        "STRIPE_PRICE_STARTER_EXPECTED_UNIT_AMOUNT_CENTS must be set to a positive integer"
    );

    let price_id = crate::common::live_stripe_helpers::stripe_price_starter_id()
    ...
    let test_clock = crate::common::live_stripe_helpers::create_test_clock(
        &stripe.client,
    ...
    let scenario_result: Result<(), String> = async {
        ...
        let customer_id = crate::common::live_stripe_helpers::create_clock_bound_customer(
            &stripe.client,
        ...
        let payment_method_id = crate::common::live_stripe_helpers::try_attach_test_payment_method(
            &stripe.client,
            &customer_id,
        )
        .await
        ...
        let subscription = crate::common::live_stripe_helpers::create_trialing_subscription_for_price(
            &stripe.client,
            &customer_id,
            &price_id,
            trial_end,
        ...
        let _ready_clock = crate::common::live_stripe_helpers::advance_test_clock_and_wait_ready(
            &stripe.client,
            &test_clock_id,
            target_frozen_time,
        )
        ...
        let paid_invoice = crate::common::live_stripe_helpers::poll_paid_invoice_for_subscription(
            &stripe.client,
            &subscription_id,
        )
        .await?;
        ...
        let latest_subscription =
            crate::common::live_stripe_helpers::retrieve_subscription(&stripe.client, &subscription_id).await?;
        assert_eq!(
    ...
    crate::common::live_stripe_helpers::cleanup_test_clock_cycle(
        &stripe.client,
