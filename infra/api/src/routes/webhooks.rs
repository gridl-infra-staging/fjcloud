...
mod canonical_sns_string_tests {
    ...
    fn subscription_envelope(sns_type: &str) -> SnsEnvelope {
        SnsEnvelope {
            ...
            subscribe_url: Some("https://sns.us-east-1.amazonaws.com/?Action=ConfirmSubscription".to_string()),
        }
    }
    ...
    fn subscription_confirmation_canonical_matches_aws_spec() {
        ...
        let actual =
            canonical_sns_string(&envelope, SnsType::SubscriptionConfirmation).unwrap();
        let expected = concat!(
            "Message\n",
            "please subscribe\n",
            "MessageId\n",
