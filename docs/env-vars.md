...
| Variable                          | Required | Default                                        | Description                                                                                                                                                                                                                 |
| --------------------------------- | -------- | ---------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ALGOLIA_MIGRATION_PROBE_TOKEN`   | Execute  | Falls back to `ALGOLIA_INVALID_CREDENTIALS_TENANT_TOKEN` | Tenant JWT used only by `ops/scripts/set_algolia_migration_availability.sh --execute` for per-instance authenticated proof of `GET /migration/algolia/availability`. The script does not print the token. |
