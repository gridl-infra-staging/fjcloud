...
const DELETE_ACCOUNT_FAILED_MESSAGE = 'Unable to delete account. Please check your password and try again.';
	...
	deleteAccount: async ({ request, locals, cookies }) => {
		...
		try {
			...
			return deleteAccountError(
				customerFacingErrorMessage(error, DELETE_ACCOUNT_FAILED_MESSAGE)
			);
		}
