...
run_live_send_seam() {
    ...
    local cargo_output
    local cargo_cmd=(cargo test -p api --test platform -- --exact email_test::ses_live_smoke_sends_verification_email --ignored)
...
summary = {
    ...
    "send_attempt": {
        ...
        "command": "cd infra && cargo test -p api --test platform -- --exact email_test::ses_live_smoke_sends_verification_email --ignored",
    },
    "suppression_check": {
