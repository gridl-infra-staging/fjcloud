...
fn build_app_with_pool(
    ...
    webhook_http_client: Arc<crate::common::MockWebhookHttpClient>,
...
fn webhook_http_client_for_fixture(
    fixture: &SnsSigningFixture,
) -> Arc<crate::common::MockWebhookHttpClient> {
    let webhook_http_client = crate::common::mock_webhook_http_client();
