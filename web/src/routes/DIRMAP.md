...
| api | The api directory contains SvelteKit server routes that expose pricing comparison and search functionality, with the search endpoint validating authentication and executing batched requests against Flapjack indexes. |
| dashboard | The dashboard directory is the customer-facing portal for fjcloud, providing interfaces for users to manage their Flapjack search indexes, configure billing and payment methods, complete onboarding flows, and handle account migrations. |
| forgot-password | — |
| login | — |
| logout | — |
| pricing | — |
