...
- Evidence: [feature-parity audit Theme A and recommendation 2](../audits/feature-parity/20260525T165423Z_fjcloud_vs_engine_dashboard_extension/SUMMARY.md); upstream references `flapjack_dev/engine/dashboard/src/pages/RuleEditorDialog.tsx`, `engine/dashboard/src/components/indexes/CreateIndexDialog.tsx`, `engine/dashboard/src/pages/dictionaries/DictionaryEntryDialog.tsx`, `engine/dashboard/src/pages/security-sources/SecuritySourceDialog.tsx`. Re-derive in `flapjack_dev`: `git ls-tree -r --name-only origin/main engine/dashboard/src | grep -E 'RuleEditorDialog|CreateIndexDialog|DictionaryEntryDialog|SecuritySourceDialog'` — all four paths present, measured 2026-08-01 @ `9596369c3`.
