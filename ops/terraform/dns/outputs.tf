...
output "ses_send_events_log_group_name" {
  description = "CloudWatch Logs group name that receives SES SEND/DELIVERY events (with invoice_id message tag) routed via EventBridge"
  value       = aws_cloudwatch_log_group.ses_send_events.name
}
