...
//   2. INTEGRATION=1 cargo test -p api --test platform integration_ -- --test-threads=1
...
///
/// Tracing subscriber state is process-global inside an integration test binary.
/// This lock serializes those assertions across modules while preserving poisoned-lock recovery.
