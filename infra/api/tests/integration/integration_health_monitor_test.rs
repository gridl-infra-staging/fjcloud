...
crate::integration_test!(health_monitor_detects_flapjack_crash, async {
    let api_url = crate::common::integration_helpers::api_base();
    let flapjack_url = crate::common::integration_helpers::flapjack_base();

    crate::require_live!(
        crate::common::integration_helpers::endpoint_reachable(&api_url).await,
        "API endpoint unreachable for health monitor test"
    );
    crate::require_live!(
        crate::common::integration_helpers::endpoint_reachable(&flapjack_url).await,
...
crate::integration_test!(health_monitor_recovers_after_flapjack_restart, async {
    let api_url = crate::common::integration_helpers::api_base();
    let flapjack_url = crate::common::integration_helpers::flapjack_base();
