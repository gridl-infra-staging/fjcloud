#!/usr/bin/env bash
set -euo pipefail
cd /Users/stuart/parallel_development/fjcloud_dev/may21_12pm_8_alert_emails/fjcloud_dev
set -a
source .secret/.env.secret
set +a

EVID_DIR="docs/runbooks/evidence/alert_emails/20260521T173845Z_staging"
REPO="/Users/stuart/parallel_development/fjcloud_dev/may21_12pm_8_alert_emails/fjcloud_dev"
