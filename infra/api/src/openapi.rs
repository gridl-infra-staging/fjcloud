...
#[openapi(
    ...
    paths(
        ...
        crate::routes::auth::resend_password_reset,
        ...
        crate::routes::billing::get_publishable_key,
        crate::routes::billing::create_setup_intent,
        crate::routes::billing::create_billing_portal_session,
        ...
        // Customer metrics
        crate::routes::indexes::index_metrics_route::get_index_metrics,
        ...
        crate::routes::indexes::debug::post_preview_event,
    ...
    components(schemas(
        ...
        crate::routes::auth::ResendPasswordResetRequest,
        ...
        crate::routes::account::AccountExportResponse,
        ...
        crate::routes::billing::PublishableKeyResponse,
        crate::routes::billing::CreateBillingPortalSessionRequest,
        crate::routes::billing::BillingPortalSessionResponse,
        ...
        crate::services::algolia_source::AlgoliaSourceListResponse,
        crate::services::algolia_source::AlgoliaIndexMetadata,
    ))
)]
pub struct ApiDoc;
