...
export class ApiClient extends BaseClient {
	...
	getPublicInfrastructure(): Promise<PublicInfrastructureResponse> {
		return this.api('GET', '/public/infrastructure', undefined, { includeAuth: false });
	}
	...
	getIndexInfrastructure(indexName: string): Promise<IndexInfrastructureResponse> {
		return this.api('GET', indexPath(indexName, '/infrastructure'));
	}
